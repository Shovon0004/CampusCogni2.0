...
interface SkillVerificationModalProps {
  isOpen: boolean
  onClose: () => void
  skillName: string // Corrected: This should be the actual skill name (e.g., "React")
  userEmail: string
...
export function SkillVerificationModal({
  ...
  }, [examData, examCompleted, examCanceled, timeLeft, userEmail, onVerificationComplete, stopCamera])
