...
export function SkillVerificationModal({
  ...
  const handleVisibilityChange = useCallback(() => {
    // Add console.log to track visibility state changes and exam status
    if (document.visibilityState === "hidden" && examStarted && !examCompleted && !examCanceled) {
      console.log("Tab switched to hidden. Attempting to cancel exam.")
      console.log(
        "Current exam state: examStarted=",
        examStarted,
        "examCompleted=",
        examCompleted,
        "examCanceled=",
